(function (global) {
  ...
  forRoute("kirikawa-news", "/government", (page) => {
    page.body = page.version === 1 ? [
      "霧川市広報デジタル資料室は、市役所地下の書庫にある広報写真を年度別に整理している。取材した2月12日は、職員3人が紙焼き写真と公開ページの記載を照合していた。",
      "契約職員の藤崎千尋さんは、公開を終えた写真も原版と来歴を分けて残す作業を担当している。机上には撮影日、所管課、公開期間を書いた一覧が置かれていた。",
      "藤崎さんは取材に対し『公開しないことと、存在しなかったことは別です』と話した。写真を非公開にした場合も、処理日と担当部署は記録するという。",
      "編集部は職員紹介ページ、当日の取材メモ、撮影画像P16を確認した。記事番号はKN-2025-0216、初出は2月16日午前8時10分。",
      "問い合わせ先は霧川市広報広聴課。この記事の訂正や追記は、記事番号を変えず末尾へ記録する。"
    ] : [
      "霧川市広報デジタル資料室では、市役所地下の書庫にある広報写真の整理が続いている。2月12日の取材では、紙焼き写真と公開ページの記載を照合する作業を確認した。",
      "資料室は撮影日、所管課、公開期間を一覧で管理し、公開を終えた画像についても処理日を記録している。",
      "この記事は2月16日午前8時10分に公開した。記事番号はKN-2025-0216、掲載写真はP16。",
      "6月19日、編集部は取材対象の氏名と引用を本文から削除した。URL、記事番号、初出時刻、掲載写真は変更していない。",
      "訂正理由と変更時刻は下記の訂正欄に記録した。確認先は霧川市広報広聴課と編集部。"
    ];
  });
