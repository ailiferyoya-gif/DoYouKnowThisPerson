(function () {
  ...
  style.textContent = `
    ...
    .recovery-grid{display:grid;grid-template-columns:minmax(250px,.72fr) minmax(0,1.8fr);gap:18px;min-height:0}.recovery-sidebar{display:grid;align-content:start;gap:12px}.recovery-section{border:1px solid #ffffff18;border-radius:13px;background:#ffffff05;padding:14px}.recovery-section h2{font-size:15px}.recovery-records{display:grid;gap:7px;min-height:0;padding-right:4px}.recovery-record{border-left:2px solid #7890b6;padding:5px 0 5px 10px}.recovery-record strong{display:block;font-size:13px}.recovery-record small{color:#8fa3c4}.recovery-empty{font-size:13px;color:#8e98a9!important}.recovery-console{display:flex;flex-direction:column;overflow-y:auto;overscroll-behavior:contain;scrollbar-gutter:stable}.recovery-console>.case-close{align-self:flex-end;flex:0 0 auto}.recovery-purpose{margin:14px 0 5px;padding:13px 15px;border-left:3px solid #9db5dc;background:#9db5dc12;color:#edf2fb}.recovery-purpose span{display:block;margin-bottom:3px;color:#94a8c7;font-size:11px;letter-spacing:.12em}.recovery-panels{flex:0 0 auto;min-height:0;overflow:visible}.recovery-panel{height:auto;min-height:0;overflow:visible;padding-right:4px}.recovery-panel[hidden]{display:none}.observation-direction{margin:8px 0 12px;padding:10px 12px;border-radius:9px;background:#0b0f17;color:#c4cedd!important}.observation-direction strong{display:block;margin-bottom:3px;color:#8fa3c4;font-size:11px;letter-spacing:.08em}
